...
namespace Intelligencia.UrlRewriter
{
    ...
    internal static class XmlNodeExtensions
    {
        ...
        public static string GetRequiredAttribute(XmlNode node, string attributeName)
        {
            return GetRequiredAttribute(node, attributeName, false);
        }
        ...
        /// <returns>The attribute value</returns>
        public static string GetRequiredAttribute(XmlNode node, string attributeName, bool allowBlank)
        {
            if (node == null)
            {
