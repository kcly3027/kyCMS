...
namespace KyCMS.Common.Collections
{
    public class CachableDictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        ...
        /// <returns></returns>
        public TValue this[TKey key, TValue defaultCachingValue]
        {
            get
            {
                return this.Get(key, defaultCachingValue);
            }
        }
        #endregion
        ...
        /// <param name="createCachingValue">The create caching value.</param>
        /// <returns></returns>
        public TValue Get(TKey key, TValue defaultCachingValue)
        {
