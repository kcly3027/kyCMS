...
namespace KyCMS.Common.Drawing
{
    ...
    public static class GraphicsExtenions
    {
        ...
        public static void DrawCircle(Graphics gp, Pen pen, Rectangle rect)
        {
        ...
        /// <param name="brush">The brush.</param>
        /// <param name="rect">The rect.</param>
        public static void FillCircle(Graphics gp, Brush brush, Rectangle rect)
        {
        ...
        /// <param name="radius">The radius.</param>
        /// <param name="corner">The corner.</param>
        public static void DrawRoundedRectangle(Graphics gp, System.Drawing.Pen pen,
          float x, float y,
          float width, float height, float radius, Corner corner = Corner.All)
        {
        ...
        /// <param name="radius">The radius.</param>
        /// <param name="corner">The corner.</param>
        public static void FillCutRectangle(Graphics gp, System.Drawing.Brush brush,
          float x, float y,
          float width, float height, float radius, Corner corner = Corner.All)
        {
            RectangleF rectangle = new RectangleF(x, y, width, height);
        ...
        /// <param name="radius">The radius.</param>
        /// <param name="corner">The corner.</param>
        public static void DrawCutRectangle(Graphics gp, System.Drawing.Pen pen,
          float x, float y,
          float width, float height, float radius, Corner corner = Corner.All)
        {
            RectangleF rectangle = new RectangleF(x, y, width, height);
