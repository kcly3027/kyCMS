...
namespace KyCMS.Common.Drawing
{
    ...
    public class WebPageCapture
    {
        ...
        internal static readonly Queue Tasks = new System.Collections.Queue();
        #endregion
        ...
        private static bool TryDequeue(Queue tasks, out WebPageCaptureTask task)
        {
            task = null;
            if (tasks.Count <= 0) return false;
            task = (WebPageCaptureTask)tasks.Dequeue();
            return true;
        }
        ...
        private static void CaptureThread()
        {
            ...
            try
            {
                ...
                while (TryDequeue(Tasks,out task))
                {
                    _lastRunningTime = DateTime.UtcNow;
