...
namespace KyCMS.Common.IO
{
    ...
    public static class IOUtility
    {
        ...
        public static IEnumerable<DirectoryInfo> EnumerateDirectoriesExludeHidden(string path)
        {
            ...
            return dir.GetDirectories().Where(it => (it.Attributes & FileAttributes.Hidden) != FileAttributes.Hidden);
        }
        /// <summary>
        ...
        {
            DirectoryInfo dir = new DirectoryInfo(path);
            return dir.GetFiles().Where(it => (it.Attributes & FileAttributes.Hidden) != FileAttributes.Hidden);
        }
        /// <summary>
        /// Enumerates the files exlude hidden.
        /// </summary>
        ...
        {
            DirectoryInfo dir = new DirectoryInfo(path);
            return dir.GetFiles(searchPattern).Where(it => (it.Attributes & FileAttributes.Hidden) != FileAttributes.Hidden);
        }
        #endregion
        #endregion
    }
