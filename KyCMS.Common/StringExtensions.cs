...
namespace KyCMS.Common
{
    ...
    public static class StringExtensions
    {
        ...
        /// <returns></returns>
        public static string Ellipsis(string str, int length, int ellipsisLength = 3)
        {
            if (str == null)
                return str;
        ...
        /// <returns></returns>
        public static string MergeName(string name)
        {
        ...
        /// <returns></returns>
        public static string SplitName(string name, bool toLower = true)
        {
        ...
        /// <returns></returns>
        public static T As<T>(string source)
        {
            if (source == null)
            {
                return default(T);
        ...
        public static T As<T>(string source, T defaultValue)
        {
            if (source == null)
            {
                return defaultValue;
        ...
        /// <returns></returns>
        public static object As(string source, Type type)
        {
            if (source == null)
            {
                return null;
        ...
        /// <returns></returns>
        public static string Items(string source, int itemIndex, string separator = ",")
        {
