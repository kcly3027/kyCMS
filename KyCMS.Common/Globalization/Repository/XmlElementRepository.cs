...
namespace KyCMS.Common.Globalization.Repository
{
    ...
    public class XmlElementRepository : IElementRepository, IDisposable
    {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<System.Globalization.CultureInfo> EnabledLanguages()
        {
            return resx.GetCultures();
        }
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<ElementCategory> Categories()
        {
            return resx.GetCategories();
        }
